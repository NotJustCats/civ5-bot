...
// ── Civilopedia ───────────────────────────────────────────────────────────────
const CIVPEDIA = {"Akkad":{"leader":"Sargon","entries":[{"type":"Ability","name":"The Great Unificatio","desc":"+3 Culture, +2 Happiness and +1 Production from conquered cities. Great Generals grant nearby Units (from any domain) a +15% Combat Bonus when initiating combat with enemy Cities."},{"type":"Building","name":"Akkadian Library","desc":"Replaces the Library. Provides +1 additional Science and does not require Gold maintenance. Costs less to produce (40 hammers vs. 50)."},{"type":"Unit","name":"Laputt","desc":"Replaces Spearmen. 3 Movement (vs. 2). Units that start their turn on the same tile as this unit copy this unit\u2019s Movement stat. Ability is kept on upgrade."},{"type":"Bias","name":"River","desc":""}]},"Aksum":{"leader":"Ezana","entries":[{"type":"Ability","name":"Saint Elesbaan's Blessi","desc":"Upon founding a Religion, your cities immediately follow it. Your religion does not exert Religious pressure on foreign cities."},{"type":"Improvement","name":"Rock-Hewn Chur","desc":"Available at Mining. Provides +2 Faith. +1 Faith at Theology . May not be built adjacent to each other nor on resource tiles. Quarries adjacent to this improvement yield +1 Faith for each adjacent. Units healing on or next to this improvement yield +2 Faith for the unit owner."},{"type":"Building","name":"King Ezana\u2019s Stel","desc":"Replaces the National Epic. Provides +3 Culture and +4 Faith in addition to its base yields. All monuments in the empire provide an additional +1 Food, +1 Production, +1 Gold and +1 Faith."},{"type":"Bias","name":"Hill","desc":""}]},"America":{"leader":"Washington","entries":[{"type":"Ability","name":"Manifest Destiny","desc":"(unchanged) - Military Land Units gain +1 Sight. Gold costs for purchasing territory are halved."},{"type":"Unit","name":"Minutem","desc":"(unchanged) - Replaces Musketmen. Ignores terrain costs, arrives trained with Drill I (+15% bonus in Rough terrain) , and earns 100% of foe\u2019s Strength as points towards a Golden Age from kills. All abilities are kept on upgrade."},{"type":"Unit","name":"Pioneer","desc":"Replaces the Settler. Has the same combat and movement properties as the Scout (preventing instant capture) and may Settle."},{"type":"Bias","name":"No","desc":""}]},"Arabia":{"leader":"Harun al-Rashid","entries":[{"type":"Ability","name":"Ships of the Desert","desc":"+1 Culture and +1 Gold from Luxury Buildings. Buildings that improve luxury resources also receive this bonus if the city has the appropriate Luxury Resource nearby. Receive twice as many Oil resources\u201d"},{"type":"Unit","name":"Camel Archer","desc":"Replaces the Knight. A Mounted Ranged Unit with 20 Ranged Strength (from 21) and 14 Combat Strength (from 17, vs. 20) Receives no penalty when initiating combat with an enemy City."},{"type":"Building","name":"Bazaar","desc":"Replaces the Market. Provides an additional happiness. Additionally every luxury resource worked by the city provides +1 Gold."},{"type":"Bias","name":"Desert, avoid wetlands","desc":"Argentina - Eva Per\u00f3n"},{"type":"Ability","name":"Pride of the Peopl","desc":"Construct Pastures and Farms twice as fast."},{"type":"Unit","name":"Gaucho","desc":"Replaces the Knight. Receives a 50% chance to withdraw from Melee attacks. Flanking bonuses are tripled. Capable of building Pastures and Farms. Abilities are lost on upgrade."},{"type":"Building","name":"Ocupada Establ","desc":"Gain +1 Food from Pasture resources and +1 Production from Maize in addition to the regular benefits of the Stable."},{"type":"Bias","name":"No","desc":"Armenia - Tiridates III"},{"type":"Ability","name":"Splendor of the Caucasus","desc":"+1 Food, +2 Production and +1 Gold from Mountains (including mountainous Natural Wonders - i.e. Kilimanjaro, Uluru, Mt. Fuji, Mt. Sinai, Mt. Kailash, Rock of Gibraltar and Sri Pada )."},{"type":"Unit","name":"Sparapet","desc":"Replaces Horsemen. Requires 80 Production and 2 Horse resources. Boasts a mighty 17 Combat Strength (vs. 12) and grants the Great General Combat Bonus to nearby allies. Does not obsolete. Keeps the ability on upgrade and only costs 1 strategic resource."},{"type":"Building","name":"Darbas","desc":"Replaces the Observatory. In addition to the typical perks, provides +4 Culture in the City and +2 Culture on Mountain tiles and Wonders for a total of +5 Science and +2 Culture on those tiles."},{"type":"Bias","name":"Hill, Avoid Jungl","desc":""}]},"Assyria":{"leader":"Ashurbanipal","entries":[{"type":"Ability","name":"Siege Warfar","desc":"Siege Units receive +1 Movement. Receive a free Great Writer at Philosophy, and receive a free Great Work of Writing upon completion of the Royal Library in the Capital."},{"type":"Building","name":"Royal Library","desc":"Replaces the Library. Provides an additional +1 Culture and Science and provides +15 (from 10) XP to Units trained in the City when its Great Work of Writing slot is filled."},{"type":"Unit","name":"Siege Tower","desc":"(unchanged) - Replaces the Catapult. A Melee Siege Unit with 12 Strength (vs. 7) only capable of combat with enemy Cities. Arrives trained with Cover I (+33% bonus defending against Ranged attacks) and Extra sight 1.. When adjacent to an enemy City, Units within 2 tiles of the Siege Tower gain a +50% Combat Bonus when initiating combat with that City. Keeps Extra sight and Cover I promotion on upgrade."},{"type":"Bias","name":"Avoid Tundr","desc":"Australia - Henry Parker"},{"type":"Ability","name":"Dreamtim","desc":"+5 Faith from Natural Wonders. Gain 10 Faith upon discovering a Natural Wonder."},{"type":"Unit","name":"Ngangkari","desc":"Replaces the Worker. 3 Movement (vs. 2) , receives an additional +1 Movement while embarked, and arrives with Medic I and II (adjacent allies heal an additional +10 HP while Fortified)."},{"type":"Building","name":"Convict Penitentiary","desc":"Replaces the Constabulary. Available at Machinery (instead of Banking). In addition to slowing the rate of Technology theft, provides +1 Gold and Production, and +5% Gold and Production in the City. Requires no Gold maintenance and is appreciably cheaper to construct (80 hammers vs. 106)"},{"type":"Bias","name":"Coast","desc":""}]},"Austria":{"leader":"Maria","entries":[{"type":"Ability","name":"Diplomatic Marri","desc":"(unchanged) - May spend Gold to annex a City-State that has been your ally for at least 5 turns."},{"type":"Unit","name":"Hussar","desc":"(unchanged) - Replaces Cavalry. +1 Sight and Movement and is 50% more effective at Flank attacks (bonus from each ally adjacent to foe increases from +10% to +15% per ally). Keeps all abilities on upgrade."},{"type":"Building","name":"Coffee Hous","desc":"Replaces the Windmill. Available at Printing Press (instead of Economics). In addition to the typical perks, provides a +5% Production bonus and a +25% Great Person generation bonus in the City. Much cheaper to construct (100 hammers from 167, vs. 167)."},{"type":"Bias","name":"Hill","desc":""}]},"Ayyubids":{"leader":"Saladin","entries":[{"type":"Ability","name":"Justice of Saladi","desc":"Receive a free Burial Tomb in each City you conquer. Workers construct improvements +25% faster. (The Burial Tomb is a unique building of Egypt that replaces the Temple. If the Temple in a captured City survives, the City will house both buildings.)"},{"type":"Building","name":"Madras","desc":"Replaces the University. In addition to the typical perks, provides +2 Faith in the City; +1 Science from Flood Plains, +2 Science from Oases."},{"type":"Unit","name":"Mamluk","desc":"Replaces the Knight. Gains a +50% bonus vs. Melee units, +25% vs. Gunpowder units. Slightly more expensive to produce (85 hammers vs. 80) Keeps the ability on upgrade."},{"type":"Bias","name":"Desert","desc":""}]},"Aztecs":{"leader":"Montezuma","entries":[{"type":"Ability","name":"Sacrificial Captives","desc":"(unchanged) - Earn 100% of foe\u2019s Strength as Culture from kills."},{"type":"Building","name":"Floating Gardens","desc":"Replaces the Watermill. In addition to the typical perks, provides +10% Food (from +15%) in the City and each Lake tile in the City provides an additional +1 (from +2) Food. In addition to Rivers, the Floating Gardens may also be constructed when adjacent to Lakes. Costs less Gold maintenance (1 Gold vs. 2)"},{"type":"Unit","name":"Jaguar","desc":"(unchanged) - Replaces the Warrior. Gains a +33% Combat Bonus in Forests and Jungles, heals 25 HP from kills, and moves unimpeded through Forests and Jungles. (These promotions are retained upon upgrade.) Keeps all abilities on upgrade."},{"type":"Bias","name":"Jungl","desc":""}]},"Babylon":{"leader":"Nebuchadnezzar II","entries":[{"type":"Ability","name":"Ingenuity","desc":"Receive a free Great Scientist in the Capital when you discover Philosophy (previously Writing). Earn Great Scientists +25% (from +50%) faster."},{"type":"Building","name":"Walls of Babylo","desc":"(unchanged) - Replaces Walls. Boosts City Strength by +6 (vs. 5) and raises City health by +100 (vs. 50). Cheaper to construct (44 hammers vs. 50)."},{"type":"Unit","name":"Bowm","desc":"(unchanged) - Replaces the Archer. 7 Melee Strength (vs. 5) and 9 Ranged Strength (vs. 7)."},{"type":"Bias","name":"Avoid Tundr","desc":""}]},"Belgium":{"leader":"Leopold II","entries":[{"type":"Ability","name":"Colonialist Riches","desc":"+1 Production from Plantations. +1 Gold from Strategic Resources."},{"type":"Building","name":"St","desc":"Replaces Zoo. In addition to the typical perks, provides an additional +1 Happiness, Culture, and Gold, and does not require Gold maintenance. Cheaper to construct (100 hammers vs. 120). Does not require a Colosseum to be built."},{"type":"Unit","name":"Force Publiq","desc":"Replaces Great War Infantry. 51 Strength (vs. 50) , arrives with Drill I (+15% bonus in Rough terrain) and Charge (+33% bonus vs. wounded Units). Promotions are kept on upgrade."},{"type":"Bias","name":"No","desc":""}]},"Boers":{"leader":"Stephanus Johannes Paulus Kruger","entries":[{"type":"Ability","name":"The Great Trek","desc":"Farms yield +1 Food when adjacent to at least 2 other Farms. This bonus is increased by +1 Gold at 3, +1 Production at 4, and +1 Culture and Science at 5 adjacent Farms."},{"type":"Building","name":"Staatsmuseum","desc":"Replaces the Opera House. Provides +1 additional Culture and houses an Artist Specialist slot. Cheaper to construct (117 hammers vs. 134)."},{"type":"Unit","name":"Voortrekker","desc":"Replaces Great War Infantry. Gains a +25% Bonus when foes initiate combat against this Unit. Heals completely from kills. Capable of building Farms in 2 turns. Slightly cheaper to construct (200 hammers vs. 210). Keeps the defense ability and still heals completely from kills on upgrade."},{"type":"Bias","name":"No","desc":"Bolivia- Tata Belzu"},{"type":"Ability","name":"Revoluci\u00f3n Nacional","desc":"Expending a Great Artist improves the yield of Mines with +1 Production and expending a Great Writer improves them with +1 Food instead. (When one yield has already been chosen, choosing the opposite will swap them instead of stacking. This ability cannot be triggered by unique Artist or Writer replacements.) Great Person: Comparsa Folklorica Replaces the Great Musician. Moves further (4 Movement vs. 2) and may be consumed to spread Tourism, begin a Golden Age, or gain a large amount of Culture."},{"type":"Unit","name":"Colorado","desc":"Replaces the Anti-Tank Rifle. 40 Strength (vs. 30). Available at Dynamite. Only receives a +100% Bonus vs. Armored Units (vs. 200) , but gains +2 Strength for every 5 points of excess Happiness in the empire. (Rounds up. Updates when a unit is moved or when a new turn begins.) Loses ability on upgrade."},{"type":"Bias","name":"Hill","desc":"Brazil - Pedro II"},{"type":"Ability","name":"Carnival!","desc":"Output 100% more Tourism and generate Great Artists, Writers, and Musicians +100% (from 50%) faster during Golden Ages. All units earn 100% of foe\u2019s Strength as points towards a Golden Age from kills."},{"type":"Unit","name":"Praci","desc":"Replaces Infantry. 80 Strength (from 70, vs. 70) Gains a +20% Combat Bonus outside of friendly territory. May move after attacking. Keeps abilities on upgrade."},{"type":"Improvement","name":"Brazilwood Camp","desc":"Available at Bronze Working (instead of Machinery). May be constructed on Jungle tiles. Provides +1 Production. Gains +2 Gold at Machinery and +2 Culture at Acoustics and improves any resources on the tile."},{"type":"Bias","name":"Jungl","desc":""}]},"Brunei":{"leader":"Bolkiah","entries":[{"type":"Ability","name":"Sea Nomads","desc":"All Naval Units may heal outside friendly territory and pay 33% less Gold maintenance. Melee Naval Units can create improvements on Coast and Ocean tiles."},{"type":"Building","name":"BMPC Plant","desc":"Replaces Oil Refineries. In addition to the typical perks, provides +3 Gold and +5 Production. Doesn\u2019t require nearby Oil to build. Upon completion, provides 2 Oil resources."},{"type":"Improvement","name":"Kampong Ayer","desc":"Requires Optics. May be built on any Coastal tile adjacent to land tiles. Provides +1 Food, Culture and Gold. +1 Production at Navigation, and +1 additional Culture at Flight."},{"type":"Bias","name":"Coast","desc":"Bulgaria - Asparukh Khan"},{"type":"Ability","name":"Cyrillic Script","desc":"Writer Specialists provide +5 Science; Science buildings provide +1 Culture."},{"type":"Unit:","name":"","desc":"Konnitsa - Replaces the Knight. Similar to an Impi, performs a Ranged attack when initiating combat. Ability is lost on upgrade."},{"type":"Building","name":"Khambar","desc":"Replaces Granary. Cheaper to construct (32 hammers vs. 40). In addition to the typical perks, yields +1 Gold from Wheat and Cattle resources."},{"type":"Bias","name":"No","desc":""}]},"Burma":{"leader":"Anawrahta","entries":[{"type":"Ability","name":"Pyu City States","desc":"+1 Happiness global happiness per city."},{"type":"Unit","name":"Aahkyayhkya Sai","desc":"Replaces the settler. The Aahkyayhkya Sai is 40% cheaper to construct, but removes a population in the city when finished. It requires the city to have at least 3 population."},{"type":"Building:","name":"","desc":"Kyawwat Replaces Stoneworks. In addition to the typical perks, the Kyawwat extends its yield bonuses to Salt and Iron resources and does not require any resources within the City to construct."},{"type":"Bias","name":"River","desc":""}]},"Byzantium":{"leader":"Theodora","entries":[{"type":"Ability","name":"Patriarchate of Constantinopl","desc":"(unchanged) - Choose an additional Pantheon, Follower, Founder or Enhancer Belief when founding a Religion."},{"type":"Building","name":"Hippodrom","desc":"Replaces Amphitheater. Slightly less costly to produce (63 hammers vs. 67) . In addition to the typical perks, also provides +2 Faith and +1 Happiness in the City."},{"type":"Unit","name":"Cataphract","desc":"(unchanged) - Replaces Horsemen. 15 Strength (vs. 12) , but 3 Movement (vs. 4) . Able to receive defensive Terrain Bonuses and is penalized slightly less for attacking Cities (-25% vs. -33%) . Abilities are lost on upgrade."},{"type":"Bias","name":"None (no longer Coastal","desc":""}]},"Canada":{"leader":"John A. MacDonald","entries":[{"type":"Ability","name":"Canadian Fur Tr","desc":"+2 Gold from Camps, +2 Gold and +1 Culture from Lake tiles."},{"type":"Unit","name":"Combat Engineer","desc":"Replaces Rifleman. Available at Industrialization. Identical Strength, but +1 Movement (3 vs. 2) . May construct Roads, Railroads and Forts, and clear Forests, Jungles and Marsh tiles. Abilities are lost on upgrade."},{"type":"Building","name":"Tim Horton\u2019s","desc":"Replaces Stock Exchange. In addition to the typical perks, provides +2 Happiness in the City and +1 Gold to river tiles worked by this City. Significantly cheaper to construct (200 hammers vs. 280)"},{"type":"Bias","name":"No","desc":""}]},"Carthage":{"leader":"Dido","entries":[{"type":"Ability","name":"Phoenecian Herit","desc":"All Coastal Cities receive a free Harbor. Units may cross mountains, receiving 50 HP damage if they end their turn on one. (The ability to cross mountains is no longer tied to earning a Great General). (Note: Harbors will only form City Connections after the discovery of the Wheel, but will still provide the appropriate Gold.)"},{"type":"Building","name":"Cotho","desc":"Replaces Lighthouse. +1 Food and +1 Production in the City in addition to the typical perks."},{"type":"Unit","name":"African Forest Elephant","desc":"Replaces Horsemen, but does not require Horses to construct. 14 Strength (vs. 12) , but 3 Movement (vs. 4) . Possesses the Feared Elephant (enemy Units adjacent to this Unit receive a -10% combat penalty) , Great Generals II (earns Great General points faster) promotion and Hannibal\u2019s Charge (+20% Strength when initiating combat from a higher elevation than foe; enemy Units will retreat if they receive more damage than this Unit, this Unit deals +50% damage to defenders incapable of retreat) . Loses the feared Elephant ability, but keeps Great Generals II and Hannibal\u2019s Charge on upgrade. (Feared Elephant will not stack.)"},{"type":"Bias","name":"Coast","desc":""}]},"Celts":{"leader":"Boudicca","entries":[{"type":"Ability","name":"Druidic Lor","desc":"Cities with an adjacent unimproved Forest tile generate +1 Faith, increasing to +2 Faith with three adjacent tiles."},{"type":"Building","name":"Silversmit","desc":"Replaces the Mint. Provides +2 Production and +1 Gold (vs. +2 Gold) and does not require resources to construct, but retains the typical perks of a Mint. Less costly to produce (50 hammers vs. 66)"},{"type":"Unit","name":"Pictish Warrior","desc":"Replaces Spearmen. Earn 100% of your foe\u2019s Combat Strength as Faith from kills (previously 50%) Gains a +20% Combat Bonus outside of friendly territory and may pillage without movement penalties. Keeps the abilities on upgrade."},{"type":"Bias","name":"Forest","desc":"Chile - Bernardo O\u2019 Higgens"},{"type":"Ability","name":"By Reason or By For","desc":"Claim all surrounding neutral tiles upon the completion of Fishing Boat or Drydock improvements. Receive a free Great Admiral at Compass. Friendly Melee & Gunpowder Units inflict a -25% Combat Penalty to adjacent enemy Naval Units; Melee Naval Units inflict this penalty to adjacent enemy Land Units. (Embarked Units do not apply these penalties.)"},{"type":"Building","name":"Cooperativ","desc":"Replaces the Factory. In addition to the typical perks, provides +2 Happiness and houses an additional Engineer Specialist (3 vs. 2). Does not require Gold maintenance. Ideologies are unlocked for Chile after the completion of only 1 Cooperative (compared to 3 Factories)."},{"type":"Unit","name":"Cardo","desc":"Replaces the Helicopter Gunship. Stronger (85 Strength vs. 70) In addition to the typical bonuses, the Cardoen is capable of attacking and capturing Cities, has 2 additional movement, and receives a +100% Combat Bonus defending against ranged attacks."},{"type":"Bias","name":"Coast","desc":""}]},"China":{"leader":"Wu Zetian","entries":[{"type":"Ability","name":"Art of War","desc":"(unchanged) - Great Generals provide an additional +15% Combat Bonus to nearby Units and are generated +50% faster."},{"type":"Building","name":"Paper Maker","desc":"(unchanged) - Replaces the Library. Requires no Gold maintenance and provides +2 Gold."},{"type":"Unit","name":"Chu-Ko-N","desc":"(unchanged) - Replaces Crossbowmen. Weaker at base (14 Strength vs. 18) , but may attack twice each turn. Ability is kept on upgrade."},{"type":"Bias","name":"No","desc":""}]},"Colombia":{"leader":"Simon Bolivar","entries":[{"type":"Ability","name":"Independence of the Peopl","desc":"+1 Food from Lumber Mills. Lumber Mills receive an additional +1 Science at Chemistry."},{"type":"Building","name":"Cacicazgo","desc":"Replaces the Granary. In addition to the typical perks, provides +1 Production and allows the City to send Production through Trade Routes (as a Workshop would). Doesn\u2019t require Gold maintenance. Slightly more expensive to construct (44 hammers vs. 40)."},{"type":"Unit","name":"Llanero","desc":"Replaces Cavalry. Capable of receiving defensive terrain bonuses and Fortifying. Ability is lost on upgrade."},{"type":"Bias","name":"Forest, Plains","desc":""}]},"Cuba":{"leader":"Fidel Castro","entries":[{"type":"Ability","name":"\u00a1Viva la Revoluci\u00f3n!","desc":"Receive +1 Culture per turn in your Capital for every 5 Culture per turn generated in the Capital of Civilizations you\u2019ve met. Upon selecting your first Ideology Tenet, receive 2 Guerrilleros in the Capital. Receive -50% less Unhappiness from Ideology pressure."},{"type":"Unit","name":"Guerrillero","desc":"Replaces Great War Infantry. Available to produce only after the adoption of Cuba\u2019s first Ideology Tenet (as opposed to Replaceable Parts). Weaker (44 Strength vs. 50) , but boasts 3 Movement (vs. 2) and can be built for significantly less (176 hammers vs. 221) . Unit upgrades with normal movement."},{"type":"Building","name":"Dance Hall","desc":"Replaces the Opera House. In addition to the typical perks, the Dance Hall provides +1 Happiness, +4 Culture, and +15% Production towards military Units in the City when its Great Work slot is filled. (This bonus is updated at the start of every turn.) Cheaper to construct (100 hammers vs. 134)"},{"type":"Bias","name":"No","desc":""}]},"Czechia":{"leader":"Vladislav II","entries":[{"type":"Ability","name":"Hussite Fervor","desc":"+100% Religious Pressure towards your own cities. Choose a Reformation belief upon founding a religio"},{"type":"Building","name":"Thaler Mint","desc":"Replaces Mint. In addition to the typical perks, yields +2 Gold from Iron and is also unlocked by it. Costs 25% less production to construct. Has a Great Merchant Specialist Slot."},{"type":"Unit","name":"Czechoslovak Legio","desc":"Replaces Foreign Legion In addition to the typical perks, it is stronger (45 strength, vs 42) , does not require a specific policy to be unlocked, and has a 33% combat bonus against military units from civilizations with a different ideology than the player who owns the unit. 33% cheaper to buy with Gold and may move immediately after doing so."},{"type":"Bias","name":"No","desc":""}]},"Denmark":{"leader":"Harald Bluetooth","entries":[{"type":"Ability","name":"Viking Fury","desc":"Embarked Units gain +1 Movement and may disembark for only 1 Movement; Civilian units may also embark for the same cost. Melee Units pillage without movement penalties."},{"type":"Unit","name":"Berserker","desc":"(unchanged) - Replaces Longswordsmen. Available at Metal Casting instead of Steel. 3 Movement (vs. 2) and ignores penalties for attacking over rivers or while embarked. Upgrades to normal movement, but keeps the Amphibious promotion."},{"type":"Unit","name":"Longship","desc":"Replaces Trireme. 6 Movement (vs. 4) . Embarked Units that begin their turn on the same tile as a Longship are granted 6 Movement for that turn. (This Movement bonus is retained after disembarkation. Promoted Longships with bonus Movement will also confer this bonus to the embarked Unit.)"},{"type":"Ability","name":"is kept on upgrade, bonus movement is lost.","desc":""},{"type":"Bias","name":"Coast","desc":""}]},"Egypt":{"leader":"Ramesses II","entries":[{"type":"Ability","name":"Monument Builders","desc":"+15% (from 20%) Production towards the construction of World Wonders and National Wonders."},{"type":"Building","name":"Burial Tomb","desc":"(unchanged) - Replaces the Temple. In addition to the typical perks, provides +2 Happiness and does not require Gold maintenance. Cities with a Burial Tomb double the amount of Gold plundered for the conqueror."},{"type":"Unit","name":"War Chariot","desc":"(unchanged) - Replaces the Chariot Archer. 5 Movement (vs. 4) and does not require Horse resources to construct. Upgrades into a normal knight."},{"type":"Bias","name":"Avoid Forest, Jungl","desc":""}]},"England":{"leader":"Elizabeth","entries":[{"type":"Ability","name":"Sun Never Sets","desc":"English Naval Units receive +2 Movement. Receive an additional Spy upon entering the Renaissance. Constabularies and Police Stations are built twice as fast and provide +1 Happiness."},{"type":"Unit","name":"Longbowm","desc":"Replaces Crossbowmen. 12 Melee Strength (vs. 13) and 18 Ranged Strength (vs. 18) , but wields 3 Range (vs. 2) . Range promotion is kept on upgrade."},{"type":"Unit","name":"Ship of the Li","desc":"Replaces the Frigate. +1 Sight. 25 Combat Strength (from 30, vs. 25) and 30 Ranged Strength (from 35, vs. 28). (The Ship of the Line has 5 Movement at base (vs. a Frigate\u2019s 6), increasing effectively to 7 due to Sun Never Sets.) Keeps the +1 Sight promotion on upgrade."},{"type":"Bias","name":"Coast","desc":""}]},"Ethiopia":{"leader":"Haile Selassie","entries":[{"type":"Ability","name":"Spirit of Adw","desc":"(unchanged) - Ethiopian Units gain a +20% Bonus in combat with Civilizations with more Cities than Ethiopia."},{"type":"Building","name":"Stel","desc":"(unchanged) - Replaces the Monument. In addition to the Culture yield, provides +2 Faith."},{"type":"Unit","name":"Mehal Sefari","desc":"Replaces Riflemen. 35 Strength (from 34, vs. 34). Arrives trained with Drill I (+15% Bonus in Rough terrain) and gains Strength according to distance from the Capital, peaking at +30% when the Mehal Sefari is stationed inside the Capital and decreasing by -3% per tile away. Cheaper to produce (134 hammers vs. 150) . Keeps the ability and the promotion on upgrade."},{"type":"Bias","name":"No","desc":""}]},"Finland":{"leader":"Mannerheim","entries":[{"type":"Ability","name":"Finnish Mobility","desc":"All Melee and Mounted Units receive a +50% increased flanking bonus (+15% per ally adjacent to foe vs. 10%) . +1 Culture from unimproved Forest tiles."},{"type":"Unit","name":"Sissi","desc":"Replaces the Machine Gun. Ignores terrain costs and receives a +25% Combat Bonus vs. Armored Units. Has an additional movement and does not spend movement when pillaging tiles, but cannot attack twice. 60 Ranged Strength (vs. 50) , 50 Melee Strength. Cheaper to construct (234 hammers vs. 260) . Keeps all abilities and promotions AND is able to attack twice on upgrade."},{"type":"Building","name":"S","desc":"Replaces the Shrine. +2 Culture from Lake tiles. Land and Naval Units trained in Cities with a Sauna heal +10 HP inside friendly territory. Costs no gold maintenance."},{"type":"Bias","name":"No","desc":""}]},"France":{"leader":"Napoleon","entries":[{"type":"Ability","name":"City of Light","desc":"+1 Culture in the Capital, increasing by an additional +15 upon the discovery of Acoustics. Theming bonuses are doubled in the Capital."},{"type":"Improvement","name":"Chat","desc":"Provides +2 Science , +2 Culture and +1 Gold, increasing by +1 Culture and +2 Gold at Flight, and +1 Science after adopting the Free Thought policy. Provides the same defensive bonus as a Fort (+50% bonus when foe initiates combat). Chateaus must be constructed adjacent to a luxury resource, non-adjacent to another Chateau, and not atop an existing Resource tile. (Resources discovered after the construction of the Chateau will provide their yield bonus to the tile, but the Chateau will not \u2018connect\u2019 those resources.)"},{"type":"Unit","name":"Musketeer","desc":"(unchanged) - Replaces Musketmen. 28 Strength (vs. 24) . That\u2019s it."},{"type":"Bias","name":"No","desc":""}]},"Franks":{"leader":"Charlemagne","entries":[{"type":"Ability","name":"Holy Roman Empir","desc":"+1 Faith from Farms. Frankish Units receive +25% additional Movement when traveling along friendly and neutral Roads and Railroads."},{"type":"Building","name":"Mead Hall","desc":"Replaces the Colosseum. Provides an additional point of Happiness (3 vs. 2) and a bonus +1 Culture. Costs 25% less production to construct. Costs no gold maintenance."},{"type":"Unit","name":"Seaxm","desc":"Replaces Longswordsmen. Available at Chivalry instead of Steel. 22 Strength (vs. 21) . Arrives trained with the Cover I (+33% bonus defending against ranged attacks) and Amphibious (attack from the sea or over rivers without penalty) promotions. Almost negligibly cheaper to construct (76 hammers vs. 80) . Promotions are kept on upgrade."},{"type":"Bias","name":"No","desc":""}]},"Gaul":{"leader":"Vercingetorix","entries":[{"type":"Ability","name":"Oppidum of Bibract","desc":"Receive a permanent Murus Gallicus in the Capital upon the discovery of Mining."},{"type":"Building","name":"Murus Gallicus","desc":"Replaces Walls. Slightly cheaper (44 Production vs. 50) and better defense (+6 vs. +5) . +1 Production and +1 Happiness; +1 additional Production after researching Metal Casting."},{"type":"Unit","name":"Noble Swordsm","desc":"Replaces Longswordsmen. 20 Strength (vs. 21) . Gains a +25% Combat Bonus when initiating combat and a +50% Bonus in Forests. Does not require Iron resources. Becomes obsolete at Rifling (instead of Gunpowder) and upgrades into Riflemen. Keeps ability on upgrade."},{"type":"Bias","name":"Forest","desc":""}]},"Georgia":{"leader":"Tamar","entries":[{"type":"Ability","name":"Ecclesiastical Architectur","desc":"Buildings unlocked by religious beliefs (except Houses of Worship) are built using Production instead (cost equal to 50% of the required Faith); these buildings provide +2 Production."},{"type":"Building","name":"Tsik","desc":"Replaces Walls. In addition to typical defensive perks, provides +3 Faith, and +1 Culture from Strategic Resources (e.g. Horses, Iron). Units trained in this City earn Golden Age points from kills (if the killed unit is pre-industrial)"},{"type":"Unit","name":"Khevsur","desc":"Replaces Swordsmen. Arrives at Guilds technology instead of Iron Working, but ignores terrain movement costs as a Scout would, and receives a +33% Combat Bonus during Golden Ages. Loses \u2018ignores terrain movement cost\u2019 on upgrade."},{"type":"Bias","name":"No","desc":""}]},"Germany":{"leader":"Bismarck","entries":[{"type":"Ability","name":"Precision Engineeri","desc":"+1 Science and Production from Workshops, Windmills, Factories and Hydro Plants. +33% faster Great Engineer generation."},{"type":"Building","name":"Hans","desc":"(unchanged) - Replaces Banks. In addition to the typical perks, gain +5% Production in the City for every Trade Route your empire currently maintains with a City-State."},{"type":"Unit","name":"Panzer","desc":"(unchanged) - Replaces the Tank. 80 Strength (vs. 70) and 6 Movement (vs. 5) . Loses bonus movement on upgrade."},{"type":"Bias","name":"No","desc":""}]},"Golden Horde":{"leader":"Batu Khan","entries":[{"type":"Ability","name":"Golden Conquest","desc":"Units are +50% more effective at intimidating City-States. Puppeted Cities provide +50% Production, Gold, and Science, and generate -33% less Unhappiness."},{"type":"Building","name":"Yam Rout","desc":"Replaces Caravansaries. Available at The Wheel instead of Horseback Riding. Retains Trade Route perks but doesn\u2019t provide Gold, instead providing +3 Science. Allows Airlifting between Cities with Yam Routes."},{"type":"Unit","name":"Ul","desc":"Replaces Pikemen. Stronger than its counterpart (17 Strength vs. 16). Behaves as a Mounted Unit and requires a Horse resource. 4 Movement (vs. 2) . Arrives with Charge (+33% bonus against wounded foes) and does not receive a penalty in combat with Cities. Keeps Charge promotion on upgrade."},{"type":"Bias","name":"No","desc":""}]},"Goths":{"leader":"Alaric I","entries":[{"type":"Ability","name":"Drauhtino","desc":"Melee and Gunpowder units receive +1 Movement.l"},{"type":"Unit","name":"Gadrauht","desc":"Replaces Longswordsman. 22 Strength (vs. 21) . Cheaper to produce (72 hammers vs. 80) and does not require Iron to train. Heals 25HP upon killing a unit. Keeps ability on upgrade."},{"type":"Improvement","name":"Harjis","desc":"Available at Mining. Must be adjacent to a Luxury resource (but not on a Luxury resource) and non-adjacent to another Harjis. Provides +1 Production. Gains an additional +1 Production upon the discovery of Iron Working, Gunpowder and Dynamite."},{"type":"Bias","name":"No","desc":"Greece - Pericles"},{"type":"Ability","name":"Hellenic L","desc":"(unchanged) - City-State Influence degrades half as slowly and recovers at twice the typical rate. Undocumented: City-State\u2019s territory is considered friendly territory (No trespassing penalty and units heal at double rate)."},{"type":"Building","name":"Odeo","desc":"Replaces the Amphitheater. Available at Writing (instead of Drama and Poetry). Provides +4 Culture (vs. 2) , +1 Gold, and does not require Gold maintenance. Houses a slot for a Great Writer specialist."},{"type":"Unit","name":"Hoplit","desc":"(unchanged) Replaces Spearmen. 13 Strength (vs. 11)."},{"type":"Bias","name":"None (previously Mixed).","desc":""}]},"Hittites":{"leader":"Muwatallis","entries":[{"type":"Ability","name":"Bronze and Iro","desc":"+1 Gold from Mines. This bonus increases to +3 gold when the mine is adjacent to at least 3 other mines. Start with Mining Technology."},{"type":"Building","name":"Lion\u2019s Gat","desc":"Replaces Walls. Cheaper to construct (40 hammers vs. 50). In addition to the typical defensive perks, provides +2 Gold and +2 Culture in the City."},{"type":"Unit","name":"Heavy Chariot","desc":"Replaces the Chariot Archer. Identical Ranged Strength and 3 Movement (vs. 4) , but 10 Melee Strength (vs. 5) . Gains a +20% defensive bonus when enemies initiate combat. Keeps ability on upgrade."},{"type":"Bias","name":"River","desc":"Hungary - Andr\u00e1s II"},{"type":"Ability:","name":"","desc":"Verszerzodes - Walls, Castles, Arsenals and Military Bases provide +1 Production and Culture. May construct up to 2 Palaces."},{"type":"Unit","name":"Black Arquebusier","desc":"Replaces Musketmen. Identical strength, but is capable of setting up to perform Ranged attacks (similar to a Siege Unit). Arrives with Accuracy I (+15% bonus in Open terrain). Slightly cheaper to produce (90 vs. 100) (Despite Accuracy typically denoting a bonus for Ranged units only, this bonus and other similar bonuses will apply to both Melee and Ranged attacks from this Unit.) Promotions are kept on upgrade. Yay!"},{"type":"Building","name":"Orszaggyules","desc":"Replaces the Palace. In addition to the regular bonuses of a Palace, provides +25% faster Great Person generation and +10% Production towards buildings in the City. Receive this building in the original Capital. Upon the discovery of Mathematics, a second Orszaggyules may be constructed in another City (for 67 hammers) ; this City becomes the new Capital of the empire. The original Orszaggyules may be sold and reconstructed to move this designation back; the Capital is located wherever the last Orszaggyules was constructed."},{"type":"Bias","name":"No","desc":""}]},"Huns":{"leader":"Attila","entries":[{"type":"Ability","name":"Scourge of Go","desc":"No longer starts with Animal Husbandry Technology. +1 Production from all Pastures. Raze Cities at double speed and borrow City names from rival Civilizations."},{"type":"Building","name":"Qara U\u2019y","desc":"Replaces the Stable. In addition to the typical perks, yields +1 Faith from Horses. Provides 2 Horse Resources for the empire upon completion."},{"type":"Unit","name":"Horse Archer","desc":"Replaces the Chariot Archer. Greater Melee Strength (7 vs. 6) , receives no movement penalty in Rough terrain, and arrives with Accuracy I (+15% bonus in Open terrain). Requires Horses to construct. Keep promotion on upgrade. Yay! (In Brave New World, this Unit did not require Horses.)"},{"type":"Bias","name":"Avoid Forest, Jungl","desc":""}]},"Inca":{"leader":"Pachacuti","entries":[{"type":"Ability","name":"Great Andean Ro","desc":"(unchanged) - Units ignore terrain costs moving through Hills. No Gold maintenance is paid for tile improvements in Hills, and half the Gold is paid for improvements elsewhere."},{"type":"Improvement","name":"Terrace Farm","desc":"(unchanged) - May only be constructed in Hills. Provides +1 Food, increasing by an additional +1 Food for every adjacent Mountain tile. Like Farms, receives an additional +1 Food if adjacent to freshwater at Civil Service, otherwise receiving this bonus at Fertilizer if not adjacent to freshwater."},{"type":"Unit","name":"Slinger","desc":"Replaces the Archer. 5 Melee Strength (from 4, vs. 5). The Slinger has a chance to withdraw from melee combat initiated by foes, avoiding some damage depending on the available Movement of the attacker and the amount of available tiles behind the Slinger. Keeps the ability on upgrade."},{"type":"Bias","name":"Hill","desc":""}]},"India":{"leader":"Gandhi","entries":[{"type":"Ability","name":"Population Growt","desc":"(unchanged) - Settling Cities produces twice as much Unhappiness. Unhappiness generated from the number of Citizens in the empire is halved. (Cities provide an additional +3 Unhappiness.)"},{"type":"Building","name":"Mughal Fort","desc":"Replaces the Castle. In addition to the typical defensive perks, provides +4 Culture (from 2) , and +2 Happiness +2 Tourism at Flight. No longer requires Walls to construct."},{"type":"Unit","name":"War Elephant","desc":"Replaces the Chariot Archer. Melee Strength (from 9, vs. 6) and 11 Ranged Strength (vs. 10) . Slightly slower (3 Movement vs. 4) and more costly to produce (46 hammers vs. 37) . Does not receive Movement penalties in Rough terrain and does not require Horses to construct. Arrives with Swift Charge (+50% bonus against Melee foes; +25% against Gunpowder foes). Keeps Swift Charge on upgrade."},{"type":"Bias","name":"No","desc":""}]},"Indonesia":{"leader":"Gajah Mada","entries":[{"type":"Ability","name":"Spice Islanders","desc":"(unchanged) Receive 2 copies of unique Luxury Resources in the first 3 Cities founded on separate landmasses. These Cities may never be Razed. (Each City must have its own unique landmass to receive a Luxury.) (Note that the unique Luxuries spawn as resource tiles beneath these Cities; if the City is settled atop an existing resource, the new Luxury will overwrite it. These resources yield +2 base gold again.)"},{"type":"Building","name":"Candi","desc":"Replaces the Garden. In addition to the typical perks, provides +2 Faith and an additional +2 Faith for each Religion with at least 1 Follower in the City. Unlike the Garden, the Candi may be built without access to freshwater. 25% less costly to construct (60 hammers vs. 80)."},{"type":"Unit","name":"Kris Swordsm","desc":"Replaces Swordsmen. 15 Strength (from 14, vs. 14) After its first combat, this Unit receives one of many unique promotions at random: Invulnerability: +30% bonus when foe initiates combat. Restore +20 additional HP while fortified. Sneak Attack: Flanking bonus increases to +15% per ally (vs. +10%). Heroism: Radiates a +15% Combat Bonus to allies within 2 tiles as if it were a Great General. Ambition: +50% bonus when initiating combat, but a -20% penalty when defending. Restlessness: +1 Movement; Unit may attack twice. Recruitment: Heal 50 HP from non-Barbarian kills. (Harmful promotions Enemy Blade and Evil Spirits have been removed.) The gained promotion is kept on upgrade. If not gained a promotion and upgraded, it can still get a promotion at random."},{"type":"Bias","name":"Coast","desc":""}]},"Ireland":{"leader":"Michael Collins","entries":[{"type":"Ability","name":"Gaelic Revival","desc":"+2 Happiness from all National Wonders (excluding the Palace). All Cities receive a +15% Production bonus towards buildings required for National Wonders."},{"type":"Unit","name":"Feni","desc":"Replaces Riflemen. Significantly stronger (40 Strength vs. 34) and significantly cheaper to construct (110 hammers vs. 150)"},{"type":"Building","name":"Irish Pub","desc":"Replaces the Zoo. In addition to the typical perks, provides +3 Food in the City and requires no Gold maintenance. +1 Production from Wine, Tea, Coffee and Tobacco resources in the City."},{"type":"Bias","name":"No","desc":""}]},"Iroquois":{"leader":"Hiawatha","entries":[{"type":"Ability","name":"The Great Warpat","desc":"(unchanged) - Units move through Forests and Jungles in friendly territory as if they were Roads. Forests and Jungles can be used to establish a City Connection upon the discovery of the Wheel, and extend the range of friendly Caravans like Roads."},{"type":"Building","name":"Longhous","desc":"Replaces the Workshop. In addition to the typical perks, the Longhouse provides +1 Production to all worked Forest and Jungle tiles in the City. Significantly cheaper to construct (50 hammers from 66, vs. 80). The Longhouse now retains the +10% Production bonus of the Workshop. Provides +1 Production to Hardwood resources in the City."},{"type":"Unit","name":"Mohawk Warrior","desc":"Replaces Swordsmen. 15 Strength (from 14, vs. 14). Receives a +33% Combat Bonus fighting in Forests and Jungles. Does not require Iron. Keeps the ability on upgrade."},{"type":"Bias","name":"Forest","desc":""}]},"Israel":{"leader":"David","entries":[{"type":"Ability","name":"Promised L","desc":"+1 Culture from Pastures."},{"type":"Unit","name":"Maccab","desc":"Replaces Swordsmen. Earn 100% of foe\u2019s Strength as Faith from kills. Significantly cheaper to construct (40 hammers vs. 50) Does not require Iron to construct."},{"type":"Building","name":"King Solomons Templ","desc":"Replaces the National College. In addition to the typical perks, grants +3 faith and awards 50 science and 50 faith upon expending a great person. May not be built with production and instead has to be bought with faith ( 260) or gold (200) (on quick speed)"},{"type":"Bias","name":"No","desc":""}]},"Italy":{"leader":"Vittorio Emanuele III","entries":[{"type":"Ability","name":"Rinascimento","desc":"+1 Culture from Specialists. Receive 250 Golden Age points upon completion of a Policy Tree, and if already in a Golden Age, extends it by 3 turns."},{"type":"Unit","name":"Pittor","desc":"Replaces the Great Artist. Golden Ages started by a Pittore last for 9 turns (vs. 6) , scaling to 14 turns with Chichen Itza or Universal Suffrage, but will not increase further with both."},{"type":"Building","name":"Basili","desc":"Replaces the Museum. Available at Industrialization (instead of Archeology). +20% faster Great Person generation in the City. Houses 2 slots for Great Artist Specialists, and generates 2 Great Artist Points each turn."},{"type":"Bias","name":"No","desc":""}]},"Japan":{"leader":"Oda Nobunaga","entries":[{"type":"Ability","name":"Bushido","desc":"(unchanged) - Units fight at full Strength even when injured. +1 Culture from all Fishing Boats and +2 Culture from Atolls."},{"type":"Building","name":"Dojo","desc":"Replaces the Barracks. In addition to the typical perks, provides +2 Science in the City and grants Units trained in this City an unconditional +10% Combat Bonus."},{"type":"Unit","name":"Samurai","desc":"(unchanged) - Replaces Longswordsmen. Arrives with Shock I (+15% bonus in Open terrain) and Great Generals II (this Unit will boost progress towards Great Generals through combat more than normal). While embarked, the Samurai may construct Fishing Boats in 4 turns. Upgrades into Rifleman instead of Musketman. Keeps the promotion and the Great Generals II ability on upgrade."},{"type":"Bias","name":"Coast","desc":""}]},"Jerusalem":{"leader":"Fulk V","entries":[{"type":"Ability","name":"Holy L","desc":"+1 Faith from Luxury Resources."},{"type":"Unit","name":"Crusader","desc":"Replaces Longswordsmen . Available at Theology (instead of Steel) Much weaker (17 Strength vs. 21) , but receives a +20% Combat Bonus in foreign territory and may enter rival territory without Open Borders. Earns Faith from kills equal to twice the Strength of defeated foes. Cheaper to construct (70 hammers vs. 80). Keeps the abilities on upgrade."},{"type":"Building","name":"Outremer","desc":"Replaces the Courthouse. In addition to the typical perks, provides +2 Culture, Faith and Happiness in the City. Costs 2 gold maintenance."},{"type":"Bias","name":"No","desc":""}]},"Khmer":{"leader":"Suryavarman II","entries":[{"type":"Ability","name":"Grand Baray of Angkor","desc":"Receive a free Baray in the Capital."},{"type":"Building","name":"Baray","desc":"Replaces the Garden. In addition to the typical perks, 10% of Food is carried over after a Citizen is born. +2 Food and +2 Faith at Drama and Poetry. The Baray may be built without access to freshwater."},{"type":"Unit","name":"Ballista Elephant","desc":"Replaces the Trebuchet, available at Machinery (instead of Physics). 18 Ranged Strength (vs. 14) , 20 Melee (vs. 12) , and 3 Movement (vs. 2) . Gains a +100% bonus initiating combat with Cities (vs. +200%) Unlike the Trebuchet, the Ballista Elephant does not receive a Sight penalty. Receives the Feared Elephant (enemy Units adjacent to this Unit receive a -10% combat penalty) promotion. (Feared Elephant will not stack.) Slightly more costly to construct (90 hammers vs. 80). Loses all abilities on upgrade."},{"type":"Bias","name":"No","desc":""}]},"Kilwa":{"leader":"Ali ibn al-Hassan Shirazi","entries":[{"type":"Ability","name":"Merchant Economy","desc":"Gain +5% Growth (excess Food) in the City for each foreign Trade Route departing the City. +4 Gold from internal Trade Routes. (Extra Food is updated the turn after the Trade Route is established.)"},{"type":"Unit","name":"Dhow","desc":"Replaces the Caravel, available at Compass (instead of Astronomy). Costs less to produce (70 hammers vs. 80) , but has 17 Strength (vs. 20) . Arrives with the Boarding Party I (+15% Combat Bonus against Naval Units) promotion. Promotion is kept on upgrade."},{"type":"Building","name":"Coral Port","desc":"Replaces the Workshop. In addition to the typical perks, provides varying yields to certain Coastal resources: +2 Production from Coral +1 Culture from Fish, Pearls, and Crabs +2 Gold from Whales"},{"type":"Bias","name":"Coast","desc":""}]},"Kongo":{"leader":"Mvemba a Nzinga","entries":[{"type":"Ability","name":"Heart of Afri","desc":"Borders naturally expand 33% faster."},{"type":"Unit","name":"Ngao","desc":"Mbeba Replaces Swordsman. 15 Strength (vs. 14) . May not initiate combat, but gains double Strength defending from Ranged attacks. Does not require Iron to produce. Keeps ability on upgrade."},{"type":"Building","name":"Slave Market","desc":"Replaces Colosseum. Subtracts 1 Citizen in the City upon completion. Provides +4 Production and +5 Gold, with an additional +3 Production and +2 Gold at Industrialization. Does not provide Happiness and does not require Gold maintenance."},{"type":"Bias","name":"Jungle, avoid desert","desc":""}]},"Korea":{"leader":"Sejong","entries":[{"type":"Ability","name":"Scholars of the Jade Hall","desc":"+1 (from +2) Science from Specialists, +2 Science from Great Person tile improvements, and +1 Science from the Palace."},{"type":"Unit","name":"Hwach\u2019","desc":"Replaces the Trebuchet. Massive 26 Ranged Strength (vs. 14) , but slightly less Melee Strength (11 vs. 12) . Suffers no Sight penalty, but receives no bonus initiating combat with Cities. Receives the Indirect Fire promotion."},{"type":"Unit","name":"Turtle Ship","desc":"(unchanged) - Replaces the Caravel. Massive 36 Strength (vs. 20) , but receives no Sight bonus, may not Withdraw from Melee attacks, and possesses 4 Movement (vs. 5). Cannot enter Ocean tiles."},{"type":"Bias","name":"Coast","desc":""}]},"Lithuania":{"leader":"Vytautas","entries":[{"type":"Ability","name":"Baltic Mythology","desc":"Great Prophets generated by or given to Lithuania cannot found a Religion and cannot create a holy site. Instead they can create a Sacred Grove. The first Great Prophet spawns with 50% less faith. Your second Great Prophet would still be the regular cost. On quick speed, this would mean your first Prophet costs 100 Faith, but the second one would cost 260 faith again"},{"type":"Improvement","name":"Sacred Grov","desc":"Provides +1 Food, Production, Culture, Science and Faith. Each yield increases by +1 upon the discovery of Philosophy, Theology, Acoustics, Archeology, Plastics, Computers, and the Internet (for a total of 8 of each yield)."},{"type":"Unit","name":"Pestininkas","desc":"Replaces the Pikeman. Identical combat capabilities, but is significantly cheaper to construct (40 Production vs. 60)"},{"type":"Building","name":"Grand Cathedral of Vilnius","desc":"Behaves like a Grand Temple but can be constructed without the presence of religion and may be built outside of a Holy City. Cheaper to construct (63 hammers vs. 84)"},{"type":"Bias","name":"Plains","desc":"Macedonia - Alexander"},{"type":"Ability","name":"Macedonian Discipli","desc":"Barracks and Armories provide +1 Food, Culture and Happiness in the City. Great Person: Hetairoi - Replaces the Great General. Considered a Mounted Unit with scaling Combat Strength and 4 Movement with identical mechanics to Horsemen, and arrives with several promotions: Leadership: rants the Great General bonus to Units within 2 tiles as a General would, Great Generals II: This Unit will earn progress towards Great Generals through combat significantly faster, Charge: +33% bonus vs. wounded foes, Heavy Charge: nemy Units will retreat if they receive more damage than this Unit; this Unit deals +50% damage to defenders incapable of retreat. Can upgrade to a Knight, but will lose its ability to create Citadels. Requires a Horse resource. (If no Horses are available when this unit is generated, it receives a Strategic Resource penalty!) Keeps all abilities on upgrade. Combat strength scales with eras as follows: Ancient Era: 12 Strength Classical Era: 16 Strength Medieval Era: 23 Strength Beings with +15 XP Renaissance Era: 30 Strength Beings with +30 XP (total) Industrial Era: 40 Strength Gains the march promotion Modern Era: 65 Strength Gains a 50% strength bonus against land units Atomic Era: 80 Strength Gains an additional movement Information Era: 100 Strength Begins with +60 XP (total)"},{"type":"Unit","name":"Sarissophoroi","desc":"Replaces Pikemen. Available at Philosophy (instead of Civil Service). Weaker, (14 Strength vs. 16) , but gains a +100% Combat Bonus (vs. +50%) against Mounted units. Loses the ability on upgrade."},{"type":"Bias","name":"No","desc":"Madagascar (Malagasy) - Ralambo"},{"type":"Ability","name":"Sacred Hills of Imeri","desc":"Purchasing cost of units or buildings with faith is reduced by 25%. Holy sites yield +1 culture and +1 faith, which increases by +1 culture and +1 faith for every other adjacent holy site."},{"type":"Unit:","name":"","desc":"Mpiambina - Replaces the Inquisitor. 130 base faith cost. (Modified by UA) Ranged Unit with 8 Melee Strength, 14 Ranged Strength, 1 Range, and 3 Movement. Also capable of melee attacks. Receives one promotion from a unique pool after its first round of combat: Kelimazala - Allows Unit to attack twice. Ramahavaly - +50% defensive bonus, -50% attacking penalty. Manjakatsiroa - +25% Combat Bonus in friendly territory. Rafantaka - Adjacent allies heal +15 HP while Fortified. This Unit heals every turn, even if an action was performed. Mosasa - + 4 Sight , +4 Range. Rabehaza - Gain a chance to capture defeated enemies. Ambohimanambola - Grant the Great General bonus to nearby allies. Sehatra - Heal fully from every kill. Lambamena - +100% bonus initiating combat with Cities. Famadiahona - Knock back foes that take more damage than this Unit receives during combat. This unit gains a chance to Withdraw from Melee combat. Razana - +3 Movement. Great Generals that start their turn on the same tile as this Unit receive +2 Movement. Masina - +75% bonus against wounded foes."},{"type":"Building","name":"Rov","desc":"Replaces Walls. In addition to the typical perks, provides +2 Food and +2 faith. Can be purchased with faith. (150 faith base cost on quick, decreased by Sacred Hills of Imerina and the piety policy Mandate of Heaven, reducing it to 70 faith together.)"},{"type":"Bias","name":"No","desc":""}]},"Manchuria":{"leader":"Nurhaci","entries":[{"type":"Ability","name":"Eight Banners","desc":"Mounted, Armored, and Bomber Units receive the Volley promotion (+50% bonus vs. Fortified Units and Cities) and pay no Gold maintenance."},{"type":"Building","name":"Canton Factory","desc":"Replaces the Bank. In addition to the typical perks, boosts City gold output by an additional +10% (+35% vs. 25%) , may house an additional Great Merchant Specialist, and is half as costly to produce (67 hammers vs. 134)"},{"type":"Unit","name":"Qianlong Cavalry","desc":"Replaces Cavalry. Stronger and faster (36 Strength vs. 34 and 5 Movement vs. 4) and arrives with Great Generals I (this Unit will boost progress towards Great Generals through combat more than normal). Keeps ability on upgrade."},{"type":"Bias","name":"No","desc":""}]},"Maori":{"leader":"Te Rauparaha","entries":[{"type":"Ability","name":"Mana of Tumat","desc":"During the first 5 turns, all units (except Recon units) receive +2 Movement and +1 Sight. After this, units receive +2 Movement during the first turn they appear. (Captured units, such as Workers, will receive this bonus on their first available move.)"},{"type":"Unit","name":"Maori Warrior","desc":"9 Strength (from 8, vs. 8) . Possesses the Haka War Dance (enemy Units adjacent to this Unit receive a -10% combat penalty) promotion. (Haka War Dance will not stack. In Brave New World, this unit belonged to Polynesia.) Keeps ability on upgrade."},{"type":"Improvement","name":"P","desc":"Available at Engineering. +2 Food and +1 Faith. May only be built on Hills without resources and cannot be constructed adjacent to one another. Gains an additional +1 Food at Civil Service and Fertilizer. Units stationed on a Pa receive a +40% defensive bonus."},{"type":"Bias","name":"No","desc":""}]},"Maurya":{"leader":"Ashoka","entries":[{"type":"Ability","name":"Inscriptions of the Dharm","desc":"All military non-armor, non-mounted, non-air units receive a 20% combat bonus when defending."},{"type":"Unit","name":"Ashoka\u2019s Envoy","desc":"Replaces the Missionary. Has 5 base movement (vs. 4), may move immediately after purchase and ignores terrain cost. Awards +1 Science, +1 Culture, +1 Gold and +1 Faith per citizen converted to a religion upon spreading one. Fully converting a city to a religion awards an additional 8 of these yields."},{"type":"Building","name":"Pillar of Ashok","desc":"Replaces the Monument. Half as costly to construct (13 hammers vs. 26) and requires no Gold maintenance. Available at Pottery (instead of immediate availability)."},{"type":"Bias","name":"No","desc":"Maya - Pacal"},{"type":"Ability","name":"The Long Count","desc":"(unchanged) - After researching Theology, choose a Great Person at the end of each Mayan calendar cycle (every 394 in-game \u2018years\u2019). Each type of Great Person may only be chosen once. (Great People chosen through Long Count cycles will delay the generation of the next naturally earned Great Person.) (Long Count intervals are based on fixed intervals regardless of when Theology was researched. Currently, these intervals are (on Quick speed): Turns 22 / 28 / 35 / 42 / 48 / 57 / 67 / 77 / 88 / 102 / 122 / 152 )"},{"type":"Building","name":"Pyrami","desc":"Replaces the Shrine. In addition to the typical perks, provides an additional point of Faith (2 vs. 1) and +2 Science, but cost slightly more to construct (26 hammers vs 20)."},{"type":"Unit","name":"Atlatist","desc":"(unchanged) - Replaces the Archer. Available immediately with identical combat capabilities and slightly less costly to construct (24 hammers vs. 27)"},{"type":"Bias","name":"No","desc":"Mexico - Benito Juarez"},{"type":"Ability","name":"Encomienda System","desc":"Receive a free Worker near the Capital at Pottery. City-States that are afraid of Mexico gain +6 Influence per turn when Mexico can demand tribute from them, but does not. Reveal all City-States within a 10-tile radius of your starting location after the end of the first turn."},{"type":"Unit","name":"Ranchero","desc":"Replaces Settler. Does not halt Growth to produce, but does not protect the City from starvation. Food does not contribute to its Production."},{"type":"Building","name":"Haci","desc":"Replaces Windmill. +1 Production from Luxury resources, +1 Gold from Bonus resources (e.g. Wheat, Fish), and +1 Food from Strategic Resources (e.g. Horses, Iron). Does not require Gold maintenance."},{"type":"Bias","name":"No","desc":""}]},"Mongolia":{"leader":"Genghis Khan","entries":[{"type":"Ability","name":"Mongol Terror","desc":"Gain a +30% Combat Bonus in combat with City-States and their Units. Mounted and Armored Units receive +1 additional Movement. pon the discovery of Chivalry, cities yield an additional +1 Food from all Horse resources. Reveal an additional Horse resource tile within the borders of every current Mongol city. (These Horses will not spawn over existing resources or features (such as forests, mountains, or Natural Wonders), but may spawn on Hills if necessary.) Great Person: Khan (unchanged) - Replaces the Great General. In addition to the typical traits, the Khan may move further (5 Movement vs. 4) and greatly improves the healing capabilities of adjacent Fortified Units by an additional +15 HP. (Note that this healing bonus will not apply to Units stationed on the same tile as the Khan.)"},{"type":"Unit","name":"Keshik","desc":"Replaces the Knight. A Ranged Mounted Unit with 17 Strength (from 15) and 17 Ranged Strength (from 16). May move after combat and receives no penalty in combat with Cities. Arrives trained with Great Generals I (this Unit will boost progress towards Great Generals through combat more than normal) and Quick Study (+50% XP earned through combat). Keeps abilities on upgrade."},{"type":"Bias","name":"Plains","desc":""}]},"Moors":{"leader":"Abd-ar-Rahman III","entries":[{"type":"Ability","name":"Glory of Al-Andalus","desc":"All Cities gain a +30% Production bonus towards buildings (not including Wonders) during the Medieval Era, decreasing to +15% in the Renaissance Era. (This ability updates on each turn or when technology is gained through other means. Upon entering the Industrial Era, the production bonus ends.)"},{"type":"Unit:","name":"","desc":"Granadine Cavalry Replaces the Lancer. A Ranged Mounted unit with identical Combat Strength to the Lancer in addition to 29 Ranged Strength and 2 Range. The Granadine Cavalry sees no bonuses against Mounted Units and may not move after initiating combat, but may attack Cities without penalty."},{"type":"Building","name":"Alcazab","desc":"Replaces the Castle. Retains defensive capabilities in addition to providing +3 Science and +10% Food in the City."},{"type":"Bias","name":"No","desc":""}]},"Morocco":{"leader":"Ahmad al-Mansur","entries":[{"type":"Ability","name":"Gateway to Afri","desc":"Receive +2 Culture (from +1) and an additional +4 Gold (from +3) for each external Trade Route sent by or to Morocco. Rivals receive an additional +2 Gold for sending Trade Routes to Morocco. Receive an additional +1 Gold and Culture for every new Era entered. (In the Ancient Era, Morocco will only receive +2 / +4; increasing to +3 / +5 in Classical, etc\u2026)"},{"type":"Improvement","name":"Kasb","desc":"Available at Guilds . May only be built on Desert tiles (excluding Oases). Provides +2 (from +1) Food +1 Production, and +1 Gold. Units gain a +50% Combat Bonus defending this tile."},{"type":"Unit","name":"Berber Cavalry","desc":"Replaces Cavalry. In addition to the typical traits, receives a +25% Combat Bonus inside friendly territory and a +50% bonus fighting in Desert, Floodplains, and Oases. Keeps abilities on upgrade."},{"type":"Bias","name":"Desert, avoid wetlands","desc":""}]},"Mughals":{"leader":"Akbar I","entries":[{"type":"Ability","name":"Diverse Administrators","desc":"Cities with a dominant foreign religion yield +1 Science, +1 Culture, and +1 Gold for every population in the city. Holy cities of Foreign Religions receive the same bonus if at least one of your original cities has been converted to that Religion. +2 Golden Age points from World Wonders."},{"type":"Building:","name":"","desc":"Mansabdari Estate - Replaces Caravansary, available at Currency (vs. Horseback Riding) . Yields +5 City strength, +2 Gold and +3 Culture if the city has a garrison"},{"type":"Unit","name":"Zafarbaks","desc":"Replaces Cannon. Costs 33% more production, 3 movement (vs. 2, does not stay on upgrade) . Has no sight penalty and is stronger (18 melee strength, vs. 14, 23 ranged strength, vs. 20)"},{"type":"Bias","name":"No","desc":""}]},"Mysore":{"leader":"Hyder Ali","entries":[{"type":"Ability","name":"Brahmin Elit","desc":"Specialists provide +1 Food and Production, but generate +50% more Unhappiness. (This Unhappiness penalty interacts additively instead of multiplicatively with other bonuses or penalties. Universal Suffrage, for example, which reduces Specialist Unhappiness by 50%, would cancel out this penalty.)"},{"type":"Unit","name":"Rocket Corps","desc":"Replaces Artillery. Increased Melee Strength (23 vs. 21) . Unlike Artillery, the Rocket Corps may attack without prior setup."},{"type":"Building","name":"Mysore Pal","desc":"Replaces the Hermitage. Available at Chivalry (instead of Architecture). Requires Walls to be built in all Cities. In addition to the typical perks, provides +3 Production, Science and Gold. Upon completion, the empire enters a Golden Age."},{"type":"Bias","name":"Hill","desc":""}]},"Nabataea":{"leader":"Aretas III","entries":[{"type":"Ability","name":"Spring of Moses","desc":"Freshwater Farms receive +1 Food at Mathematics rather than Civil Service."},{"type":"Unit","name":"Zabo","desc":"Replaces the Scout. May not attack. 3 Movement (vs. 2) May discover Cities from an additional +3 tiles away. When this Unit discovers a Capital or City-State, gain +10 Gold for the Empire. Will not upgrade from Ruins. (The Zabonah must make Sight contact with players and City-States to \u2018meet\u2019 them and will not \u2018meet\u2019 when discovering Cities only due to its expanded range.)"},{"type":"Building","name":"Rock-Cut Tomb","desc":"Replaces the Caravansary. In addition to the typical perks, provides an additional +1 Gold (3 vs. 2) and +2 Food in the City. Gains an additional +1 Food for each Trade Route departing the City."},{"type":"Bias","name":"Desert","desc":""}]},"Netherlands":{"leader":"William","entries":[{"type":"Ability","name":"Dutch East India Company","desc":"+1 Happiness from each unique Luxury in the empire and +1 Gold from Luxury resource tiles."},{"type":"Improvement","name":"Polder","desc":"Available at Guilds. May be built on Marsh and Floodplain tiles and on Lakes or Coastal tiles with at least 3 adjacent land tiles. +3 Food if constructed on Marsh, +2 Food if constructed on Lakes or Coast. Gains +1 Production and +2 Gold at Economics."},{"type":"Unit","name":"Sea Beggar","desc":"Replaces the Privateer. 27 Strength (from 25, vs. 27). Arrives with the Supply (may heal outside friendly territory; heals 15 HP each turn), Coastal Raider (+20% bonus when attacking Cities; Steal Gold equal to 33% of inflicted damage) and Boarding Party I (+15% bonus in Melee combat with Naval Units) promotions. Promotions are kept on upgrade, heal on unit kill ability is kept on upgrade."},{"type":"Bias","name":"Coast; near Wetlands (Marsh and Floodplains) (previously Grassland).","desc":""}]},"New Zealand":{"leader":"Michael Joseph Savage","entries":[{"type":"Ability","name":"Where She Goes","desc":"Earn 10 Faith, 6 Culture, 40 Gold, or 12 Science when meeting a Civilization or City-State for the first time. (This bonus is randomly chosen.)"},{"type":"Unit","name":"Defender","desc":"Replaces the Ironclad. 50 Strength (vs. 45) . Has Coast guard ability, which gives a +15% bonus inside friendly territory and ignores Zone of Control movement penalties when within 2 tiles of an owned City or a City from a player whom you have an active Declaration of Friendship with. In addition to the typical traits, arrives with Cover I ( gain a +33% bonus defending against Ranged attacks). Doesn\u2019t require Coal. Promotions and Coast guard ability is kept on upgrade"},{"type":"Unit","name":"Maori Battalio","desc":"Replaces Infantry. Possesses the promotions and traits of a Marine. Receive a Combat Bonus the further this unit is away from the Capital (+2% per tile to a maximum of +40%). Each Battalion stationed within a City-State\u2019s borders earns +1 Influence with that City-State each turn. Promotions and ability is kept on upgrade."},{"type":"Bias","name":"Coast","desc":""}]},"Normandy":{"leader":"William the Conqueror","entries":[{"type":"Ability","name":"Castle Builders","desc":"Units gain a +10% Combat Bonus outside of friendly territory. Cities receive +5 additional Strength."},{"type":"Improvement","name":"Motte and Bailey","desc":"Available at Engineering. +1 Food and Production. +2 Culture at Flight. Cannot be built adjacent to one another. Units gain a +25% Combat Bonus defending this tile."},{"type":"Unit","name":"Pedit","desc":"Replaces the Longswordsman. Available at Metal Casting (instead of Steel). 20 Strength (vs. 21) . Marginally cheaper to produce (77 hammers vs. 80) . Arrives with Shock I (+15% bonus vs. foes in Open terrain) and may construct Motte and Baileys. Promotions are kept on upgrade."},{"type":"Bias","name":"No","desc":""}]},"Norway":{"leader":"Harald Hardrada","entries":[{"type":"Ability","name":"Nordic Bounty","desc":"+1 Faith from Coastal resources. +2 Food and +1 Production from Snow tiles."},{"type":"Unit","name":"Ski Infantry","desc":"Replaces Great War Infantry (previously Riflemen). Matches the strength of its counterpart and arrives with Drill I and II (total of +30% bonus fighting in Rough terrain) and the unique Ski Infantry promotion (+25% bonus fighting in Snow, Tundra and Hills without Forests or Jungles; move twice as far through these tiles). (In Brave New World, this unit belonged to Denmark.) Promotions and the ability is kept on upgrade."},{"type":"Building","name":"Stave Chur","desc":"Replaces the Temple. +1 Production from Tundra and Snow tiles. Cheaper to construct (36 hammers vs. 50) and requires no Gold maintenance."},{"type":"Bias","name":"Coast, tundra, avoid desert","desc":""}]},"Nubia":{"leader":"Amanitore","entries":[{"type":"Ability","name":"Ta Seti","desc":"Begin with a free Apedemak\u2019s Bow."},{"type":"Unit","name":"Apedemak\u2019s Bow","desc":"Replaces the Scout and has identical Strength, but is classified as a Ranged unit and may attack with 3 Range. Will not upgrade from Ruins, but can upgrade with Gold like the Scout when appropriate."},{"type":"Building","name":"Blast Fur","desc":"Replaces the Forge. In addition to the typical perks, provides +2 Culture by default, +2 Culture from Iron resources, and newly-trained Ranged, Siege and Recon units receive the Accuracy I (+15% bonus in Open terrain) promotion for free. Does not require resources nearby and does not require Gold maintenance."},{"type":"Bias","name":"Desert, avoid wetlands","desc":""}]},"Oman":{"leader":"Saif bin Sultan","entries":[{"type":"Ability","name":"Chain of the Eart","desc":"All Naval Units ignore Zone of Control movement penalties. Receive a free Seaport in conquered Cities."},{"type":"Unit","name":"Baghl","desc":"Replaces the Galley. Greater Melee Strength (8 Strength vs. 6) and Ranged Strength (12 vs. 8). Moves further (4 Movement vs. 3) and receives Faith and Gold from kills equal to the Strength of the defeated foe. Arrives with the Coastal Raider I (+15% bonus initiating combat with Cities; steal Gold equal to 33% of inflicted damage) promotion. Promotions are kept on upgrade, but the kill reward ability is lost. The Coastal Raider promotion does provide the combat strength against cities, but not the gold on attack, as it is not a melee attack."},{"type":"Building","name":"Minaa\u2019","desc":"Replaces the Harbor. Enemy Naval Units take 30 damage if they end their turn next to this City. Provides +5 City Strength, and +2 Production for each Trade Route departing the City. Allows units to Airlift between Cities with Minaa\u2019s."},{"type":"Bias","name":"Coast","desc":""}]},"Ottomans":{"leader":"Suleiman","entries":[{"type":"Ability","name":"Millets","desc":"Each City gains +1 Local Happiness for each Religion present in the City. Receive Faith when promoting Units equal to the required experience (not when insta-healing)."},{"type":"Unit","name":"Sipahi","desc":"Replaces the Lancer. In addition to the typical traits, receives +1 Sight and Movement (5 vs. 4) and may Pillage without movement penalty. Available at Printing Press (previously Metallurgy) and costs less to produce (99 hammers from 123, vs. 123). Promotions and the ability are kept on upgrade."},{"type":"Unit","name":"Janissary","desc":"Replaces Musketmen. Gains a +25% bonus when initiating combat and heals 50 HP from kills. Less costly to produce (80 from 100, vs. 100). Keeps abilities on upgrade."},{"type":"Bias","name":"None (previously Coast","desc":""}]},"Palmyra":{"leader":"Zenobia","entries":[{"type":"Ability","name":"Pearl of the Desert","desc":"Cities provide fresh water to all adjacent tiles. Gardens, Water Mills and Hydro Plants ignore terrain requirements."},{"type":"Building","name":"Palmyrene Theater","desc":"Replaces Amphitheaters. Provides +2 Gold. +1 Production, Gold, and Culture from Oases, +1 Production from Lake tiles. Doesn\u2019t require Gold maintenance."},{"type":"Unit","name":"Clibanarius","desc":"Replaces Horsemen. 14 Strength (vs. 12), arrives with Heavy Charge (enemy Units will retreat if they receive more damage than this Unit; this Unit deals +50% damage to defenders incapable of retreat) . Keeps ability on upgrade."},{"type":"Bias","name":"Desert","desc":"Papal States (Vatican) - Urban II"},{"type":"Ability","name":"The Holy S","desc":"Owned occupied Cities that follow your Religion instantly receive a Courthouse. +2 Food, +1 Gold and +1 Culture from Great Person Tile Improvements. Units receive faith from kills."},{"type":"Unit","name":"Swiss Guar","desc":"Replaces Landsknecht. Does not require the Mercenary Army policy, but still must be purchased. Available at Economics. More expensive to purchase (210 Gold vs. 160) , but is faster (3 Movement vs. 2) and significantly stronger (25 Strength vs. 16) . Receives Faith (double) and Gold from kills equal to the Strength of the defeated foe, receives gold from damage inflicted to cities and arrives with Medic I and II (adjacent allies heal a total of +10 additional HP while Fortified). May upgrade into Riflemen. Promotions and abilities are kept on upgrade."},{"type":"Building","name":"Saint Peter\u2019s Basili","desc":"Replaces the Grand Temple. In addition to the typical perks, provides a free Cathedral in the City and spawns a Great Prophet near the City. Receive 2 delegates in the World Congress."},{"type":"Bias","name":"No","desc":""}]},"Persia":{"leader":"Darius I","entries":[{"type":"Ability","name":"Achaemenid Legacy","desc":"Golden Ages last +50% longer. During a Golden Age, Units receive +1 Movement. No longer receives a +10% Combat Bonus during a Golden Age."},{"type":"Building","name":"Satrap\u2019s Court","desc":"(unchanged) - Replaces the Bank. In addition to the typical perks, provides an additional +1 Gold (3 vs. 2) and +2 Happiness."},{"type":"Unit","name":"Immortal","desc":"(unchanged) - Replaces Spearmen. 12 Strength (vs. 11). In addition to the typical traits, the Immortal heals an additional +10 HP while fortified. Keeps ability on upgrade."},{"type":"Bias","name":"No","desc":""}]},"Philippines":{"leader":"Emilio Aguinaldo","entries":[{"type":"Ability","name":"The Good Fight","desc":"Your Civilian Units receive +2 Movement in your own territory. The first two Cities you settle (after your Capital) begin with +1 extra Citizen."},{"type":"Unit","name":"Gerily","desc":"Replaces Expeditionary Forces. Boasts a whopping 55 Strength (vs. 40) . In addition to the Force\u2019s innate promotions, the Gerilya arrives with Volley (gain a +50% bonus against Fortified Units and Cities), 3 Movement (vs. 2) +3 additional Movement while embarked, and +1 Sight while embarked. Keeps abilities on upgrade."},{"type":"Building","name":"National Chur","desc":"Replaces the Zoo, but available at Compass instead of Printing Press. In addition to the typical perks of a Zoo, the National Church provides +1 Culture and +2 Faith, and provides +15 XP to Units trained in the City. Less costly to construct (100 hammers vs. 120)."},{"type":"Bias","name":"Coast","desc":""}]},"Phoenicia":{"leader":"Hiram","entries":[{"type":"Ability","name":"Skillful Traders","desc":"Receive a Square Sail Ship at Sailing. Upon the discovery of Optics, newly settled Cities begin with +1 extra Citizen and you earn 50 gold."},{"type":"Unit","name":"Square Sail Ship","desc":"Replaces the Trireme. Can see 1 tile further than its counterpart and receives the Supply (may heal outside friendly territory; heals 15 HP each turn) promotion. Slightly cheaper to train (25 hammers vs. 30) . Promotions are kept on upgrade."},{"type":"Building","name":"Trade Harbor","desc":"Replaces the Harbor. In addition to the typical perks, provides +15% production towards Naval units and +1 Production from all Coastal resources."},{"type":"Bias","name":"Coast","desc":""}]},"Poland":{"leader":"Casimir III","entries":[{"type":"Ability","name":"Solidarity","desc":"Social Policies require -10% less Culture to adopt."},{"type":"Building","name":"Ducal Stabl","desc":"Replaces the Stable. In addition to the typical perks, provides +1 Gold from each Horse, Sheep, Cattle and Maize resource in the City. +15 XP for Mounted Units trained in the City. Requires no Gold maintenance."},{"type":"Unit","name":"Winged Hussar","desc":"Replaces the Lancer. 28 Strength (vs. 25) and 5 Movement (vs. 4) . In addition to the Lancer\u2019s innate promotions, arrives with the Heavy Charge ( enemy Units will retreat if they receive more damage than this Unit; this Unit deals +50% damage to defenders incapable of retreat) promotion. No longer arrives with Shock (+15% bonus vs. foes in Open terrain). Keeps ability on upgrade."},{"type":"Bias","name":"Plains","desc":""}]},"Polynesia":{"leader":"Kamehameha","entries":[{"type":"Ability","name":"Wayfindi","desc":"Units may embark and move through Oceans immediately. Embarked Units gain +1 Movement, +2 Sight (from +1) and double defensive Strength. Units gain a +10% Combat Bonus fighting within 2 tiles of a Moai."},{"type":"Improvement","name":"Moai","desc":"Available at Construction. Must be built on land adjacent to the coast. Provides +1 Culture and gains an additional +1 Culture for each adjacent Moai. Gains +1 Gold at Flight. You can now build Moais on tiles with resources and any resource it is constructed on will be improved."},{"type":"Unit","name":"Ko","desc":"Replaces Longswordsmen. 23 Strength (vs. 21) , requires no Iron resources, and arrives with the Amphibious (attack from the sea or over rivers without penalty) promotion. Obsolete at Rifling (instead of Gunpowder). Promotion is kept on upgrade."},{"type":"Bias","name":"Coast","desc":""}]},"Portugal":{"leader":"Maria I","entries":[{"type":"Ability","name":"Mare Clausum","desc":"Receive twice as much Gold from Resource Diversity from Trade Routes. Caravans and Cargo Ships are 33% less costly to construct."},{"type":"Building","name":"Feitori","desc":"Replaces the Harbor. In addition to the typical perks, provides +1 Gold from Coastal resources. Naval units trained in this City receive +15 XP. Cheaper to construct (67 hammers vs. 80) and doesn\u2019t require Gold maintenance."},{"type":"Unit","name":"N","desc":"(unchanged) - Replaces the Caravel. 6 Movement (vs. 5) . In addition to the typical perks, the Nau may perform a unique action when adjacent to foreign territory, gaining Gold for the empire and XP for the Unit scaling with the distance from Portugal\u2019s Capital. Keeps ability on upgrade, increased movement is lost."},{"type":"Bias","name":"Coast","desc":""}]},"Prussia":{"leader":"Frederick","entries":[{"type":"Ability","name":"Army with a Stat","desc":"All Land Units may receive unique Promotions upon leveling up. +50% Food and Production from internal Trade Routes."},{"type":"Building","name":"Fabrik","desc":"Replaces the Factory. 25% cheaper to produce (180 hammers vs. 240) and does not require Coal resources."},{"type":"Unit","name":"Landwehr","desc":"Replaces Riflemen. Available at Military Science instead of Rifling. Arrives trained with Blitz (may attack twice each turn) and Quick Study (+50% Experience earned through combat). 3 Movement (vs. 2). Promotions and abilities are kept on upgrade."},{"type":"Unique","name":"Promotions:","desc":"Tier 0 - Gehorsam : Designates Units capable of learning further Promotions. Tier 1 - Disziplin : +10% Combat Strength. Tier 2 - Fleiss : +25% bonus attacking, or Tapferkeit : +25% bonus defending. Tier 3 - Zielstrebigkeit : +1 Extra Attack (requires Fleiss), H\u00e4rte : +50% Defensive Strength vs. Ranged Units (requires Tapferkeit), or P\u00fcnktlichkeit : +1 Movement (requires either). Zielstrebigkeit cannot be chosen by Paradropping Units.) Tier 4 - Zuverl\u00e4ssigkeit : Gain a bonus when near Great Generals and Heal every turn (requires Zielstrebigkeit), Zur\u00fcckhaltung : +30% bonus in friendly territory (requires H\u00e4rte), or Pflichtbewusstsein : +50% bonus vs. Mounted and Armored Units in addition to +1 Movement (requires P\u00fcnktlichkeit)."},{"type":"Bias","name":"No","desc":""}]},"Romania":{"leader":"Carol I","entries":[{"type":"Ability","name":"Nihil Sine Deo -","desc":"Units gain a +10% Combat Bonus against wounded foes. +25% Culture output during Golden Ages (for a total of +45% Culture). Receive 100 Golden Age points upon capturing or liberating a city."},{"type":"Unit","name":"Vanator","desc":"Replaces the Gatling Gun. 31 Melee and Ranged Strength (vs. 30) and 2 Range (vs. 1) . Promotions are kept on upgrade."},{"type":"Building","name":"Painted Monastery","desc":"Replaces the Garden. In addition to the typical perks, provides +1 Production, +2 Faith, and +1 Great Artist point per turn. Does not require freshwater. Cheaper to construct (67 vs. 80 hammers)"},{"type":"Bias","name":"No","desc":""}]},"Rome":{"leader":"Augustus Caesar","entries":[{"type":"Ability","name":"Glory of Rom","desc":"(unchanged) - Gain +25% Production towards any Buildings that already exist in the Capital."},{"type":"Unit","name":"Ballist","desc":"Replaces the Catapult. 8 Melee Strength (vs. 7) and 10 Ranged Strength (vs. 8) May attack without prior setup. Receives the Indirect Fire promotion. Loses ability on upgrade. Receives only a 100% bonus towards combat with cities (instead of 200%)"},{"type":"Unit","name":"Legio","desc":"Replaces Swordsmen. 16 Strength (from 17, vs. 14) May construct Roads and Forts."},{"type":"Bias","name":"No","desc":""}]},"Russia":{"leader":"Catherine","entries":[{"type":"Ability","name":"Siberian Riches","desc":"+1 Production from Iron, Coal, Aluminum, and Uranium resources and each of these resources, including horses, provide double quantity. All Strategic Resources may be improved instantly."},{"type":"Building","name":"Krepost","desc":"Replaces Barracks. In addition to the typical perks, reduces the Culture and Gold costs of acquiring tiles in the City by -25%."},{"type":"Unit","name":"Cossack","desc":"Replaces Cavalry. In addition to the typical traits, gains a +25% bonus (from +33%) in combat with wounded foes. Keeps ability on upgrade and Charge can still be picked as a promotion."},{"type":"Bias","name":"Tundr","desc":""}]},"Scotland":{"leader":"Robert the Bruce","entries":[{"type":"Ability","name":"Flower of Scotl","desc":"+2 Production, Science and Culture from Writer's, Artist's and Musician's Guilds. +33% faster Great Person generation in the Capital."},{"type":"Unit","name":"Gallowglass","desc":"Replaces Riflemen. Cheaper to construct (120 hammers vs. 150) and available at Metallurgy (instead of Rifling). 32 Strength (vs. 35) . Arrives with Altitude Training (+10% bonus fighting in Hills; move twice as fast through these tiles) and Volley (+50% bonus vs. Fortified Units and Cities). Keeps abilities on upgrade. Unlike Riflemen, requires 1 Iron resource to train."},{"type":"Building","name":"Ceilidh Hall","desc":"(unchanged) - Replaces the Opera House. In addition to the typical perks, provides an additional +1 Culture and +3 Happiness in the City. (In Brave New World, this building belonged to the Celts.)"},{"type":"Bias","name":"Hill","desc":""}]},"Shoshone":{"leader":"Pocatello","entries":[{"type":"Ability","name":"Great Expans","desc":"Founded Cities start with 4 additional tiles (previously 8) claimed. Units gain a +15% Combat Bonus in their own territory."},{"type":"Unit","name":"Pathfinder","desc":"Replaces the Scout. 27 hammers to produce (from 30, vs. 16). 8 Strength (vs. 5). When entering Ancient Ruins, the Pathfinder may select the benefit from the available pool. (This Unit upgrades into a Composite Bowman (instead of an Archer) from Ruins.) Keeps the ability on upgrade."},{"type":"Unit","name":"Comanche Riders","desc":"(unchanged) - Replaces Cavalry. 5 Movement (vs. 4) and costs less to produce (132 hammers vs. 150) . Keeps the movement ability on upgrade."},{"type":"Bias","name":"No","desc":""}]},"Siam":{"leader":"Ramkhamhaeng","entries":[{"type":"Ability","name":"Father Governs Childr","desc":"(unchanged) - Gain +50% more Food, Culture Faith and Happiness from friendly City-States. Units from Military City-States arrive with an additional +10 XP and arrive +50% faster."},{"type":"Building","name":"Wat","desc":"Replaces the University. In addition to the typical perks, provides +3 Culture. Significantly cheaper to construct (80 vs 108 production) and requires no maintenance."},{"type":"Unit","name":"Naresuan\u2019s Elephant","desc":"(unchanged) - Replaces the Knight. 25 Strength (vs. 20) , but 3 Movement (vs. 4) . Gains a +50% bonus against Mounted Units and does not require Horses to construct. Loses ability on upgrade."},{"type":"Bias","name":"avoid Forest","desc":"Sioux- Sitting Bull"},{"type":"Ability","name":"Dwellers of the Plains","desc":"Units receive a +15% Combat Bonus fighting in Plains."},{"type":"Unit","name":"Buffalo Hunter","desc":"Replaces Composite Bowman. 12 Ranged Strength (vs. 11) 8 Melee (vs. 7) . Capable of constructing Tipis."},{"type":"Improvement","name":"Tipi","desc":"Available at Trapping. May only be constructed on flat Plains or flatland Deer / Bison resources and must be adjacent to a Luxury resource. Provides +1 Food, +1 Faith. Bonus +1 Culture if adjacent to a city and +1 Gold if adjacent to a River. Gains +1 Food at Civil Service and +1 Faith at Theology."},{"type":"Bias","name":"Plains","desc":"Songhai - Askia"},{"type":"Ability","name":"River Warlor","desc":"Receive triple Gold from clearing Barbarian camps and capturing Cities. Land Units receive the Amphibious (attack from the sea or over rivers without penalty) promotion and ignore terrain costs moving along or across Rivers."},{"type":"Building","name":"Mud Pyramid Mosq","desc":"(unchanged) - Replaces the Temple. In addition to the typical perks, provides +2 Culture and requires no Gold maintenance."},{"type":"Unit","name":"Mandekalu Cavalry","desc":"(unchanged) - Replaces the Knight. Receives no penalty in combat with Cities and is slightly cheaper to produce (74 hammers vs. 80) . Loses the ability on upgrade."},{"type":"Bias","name":"River","desc":""}]},"Spain":{"leader":"Isabella","entries":[{"type":"Ability","name":"Seven Cities of Gol","desc":"Gain 100 Gold (previously 500 if first to discover and 100 otherwise) and +1 additional Happiness for the empire upon the discovery of a Natural Wonder. Tile yields (including Happiness yields) from Natural Wonders are doubled."},{"type":"Building","name":"Plaza de Toros","desc":"Replaces the Circus. In addition to the typical perks, provides +2 Culture, and may also be built with an improved source of Cattle in addition to Horses and Ivory."},{"type":"Unit","name":"Tercio","desc":"(unchanged) - Replaces the Musketman. 26 Strength (vs. 24) and gains a +50% bonus against Mounted Units, but is slightly more expensive to construct. (107 hammers vs. 100). Loses the ability on upgrade. (This unit is classified as a Melee Unit and not a Gunpowder Unit.)"},{"type":"Bias","name":"Coast","desc":"Sumeria - Gilgamesh"},{"type":"Ability","name":"Cradle of Civilizatio","desc":"+2 Culture from every City upon the discovery of Drama and Poetry."},{"type":"Building","name":"Ziggurat","desc":"Replaces Temple. In addition to the Faith yield, provides +10% Science. Only costs 1 Gold to maintain (vs. 2)"},{"type":"Unit","name":"Phalanx","desc":"Replaces Spearman. Available at Mining. +50% more effective at flanking (+15% per adjacent ally vs. +10%) and cheaper to construct (30 hammers vs. 37) . Keeps ability on upgrade."},{"type":"Bias","name":"River","desc":""}]},"Sweden":{"leader":"Gustavus Adolphus","entries":[{"type":"Ability","name":"Nobel Priz","desc":"+20% faster Great Person generation in all Cities. Receive 100 Influence and 200 Gold when gifting a Great Person to a City-State."},{"type":"Unit","name":"Carol","desc":"Replaces Musketmen (instead of Riflemen). 3 Movement (vs. 2) Identical strength; arrives with March (heal 10 HP each turn even if an action was performed). Promotions are kept on upgrade."},{"type":"Building","name":"Falu Gruv","desc":"Replaces Ironworks. Available at Metal Casting (instead of Machinery) . In addition to the typical perks, provides +1 Production to all Hill tiles in the City. Provides +6 Tourism at Flight."},{"type":"Bias","name":"Tundra, avoid desert","desc":""}]},"Switzerland":{"leader":"Jonas Furrer","entries":[{"type":"Ability","name":"Swiss Banks","desc":"Merchant Specialists provide +2 Production and Science."},{"type":"Building","name":"Ski Resort","desc":"Replaces Stadiums. Available at Electricity (instead of Refrigeration). Provides +3 Happiness (vs. 2), +3 Culture, and +5 Tourism. Provides an additional +5 Tourism and +2 Gold for every Mountain within 3 tiles of the City. Half as costly to construct (165 hammers vs. 330) and doesn\u2019t require Gold maintenance. Doesn\u2019t require a Zoo to construct."},{"type":"Building","name":"Reisl\u00e4ufer Post","desc":"Replaces Armories. Trained units receive the Mountaineer promotion (+10% Strength and +1 Movement at the start of turn when adjacent to Mountain tiles) . Doesn\u2019t require Gold maintenance. Spawns a Reisl\u00e4ufer upon completion."},{"type":"Unit","name":"Reisl\u00e4ufer","desc":"A unique Unit only available by completing Reisl\u00e4ufer Posts. Comparable to Longswordsmen with 20 Strength and 3 Movement. Receives Gold from defeated foes equal to twice their Strength. Upgrades into Rifleman and keeps the Mountaineer ability."},{"type":"Bias","name":"Hills","desc":""}]},"Tibet":{"leader":"Ngawang Lobsang Gyatso","entries":[{"type":"Ability","name":"Eightfold Path to Nirv","desc":"Receive +2 Food, Production, Gold, Culture, Faith and Science in the Capital and the first city founded with the Dalai Lama upon the discovery of Drama and Poetry. Receive +1 to those yields for every Era you advance past the Classical Era."},{"type":"Unit","name":"Dalai Lam","desc":"Replaces Great Prophets generated and received by Tibet. No vision penalty and may spread Religion 1 extra time. May also start 6-turn Golden Ages (consuming the unit)."},{"type":"Improvement","name":"Monastery","desc":"Available at Calendar. Can only be built on Hills. Provides +2 Faith and +1 Culture; +1 additional Faith at Theology. +1 Culture for each adjacent Mountain. Receive +1 Culture at Acoustics and +1Gold, +1 Culture at Flight. May be built in Forests and Jungles without removing them."},{"type":"Bias","name":"No","desc":""}]},"Timurids":{"leader":"Timur","entries":[{"type":"Ability","name":"Ulugh Beg\u2019s Observatory","desc":"+5 City Strength and +15% Science, Gold and Culture in the original Capital. These bonuses are terminated if the original Capital is captured."},{"type":"Unit","name":"Timurid Rider -","desc":"Medieval Air Unit available at Chivalry. Replaces Horsemen. Requires 1 Horse; has 5 Range and 19 Combat Strength. Behaves as an Air Unit, and receives the appropriate promotions."},{"type":"Building","name":"Serai","desc":"Replaces Caravansary. Instead of providing +2 Gold at base, provides +1 Gold for every 3 Citizens in the City and otherwise retains the typical perks. Allows units to Airlift between Cities with Serais and increases Air Unit capacity in the City by 1. More costly to construct (67 hammers vs. 60) (This bonus scales linearly. In practice, each Citizen provides +0.33 Gold.)"},{"type":"Bias","name":"Hill","desc":"Tonga - ' Aho'eitu"},{"type":"Ability","name":"The Friendly Islands","desc":"Resting Influence with City-States is increased by 5. All Islands, Coast tiles, and Coast-adjacent land tiles within a 10-tile radius of your starting Settler are revealed immediately."},{"type":"Unit","name":"Matato\u2019","desc":"Replaces the Archer (but does not require Archery to construct). 3 Movement (vs. 2) and +1 Sight; these bonuses are lost with upgrades. Cheaper to construct (20 hammers vs. 26). Obsolete at Machinery. Cannot upgrade from Ruins. Loses all ability on upgrade."},{"type":"Building","name":"Mala\u2019","desc":"Replaces the Granary. Available at Sailing. Provides +1 Faith. Provides +2 Food and Culture if the city is adjacent to at least 3 Coastal tiles."},{"type":"Bias","name":"Coast","desc":""}]},"Tunisia":{"leader":"Farhat Hached","entries":[{"type":"Ability","name":"Khums","desc":"+100% Food, Production, and Gold from land-based Trade Routes. Melee units spend one less movement upon attacking a city (Units that cannot move after attacking still spend all movement)"},{"type":"Building","name":"Ribat","desc":"Replaces Castle, yields +2 Gold, +2 Faith, and +4 Golden Age Points. 50% Cheaper to construct. Does not require Walls"},{"type":"Unit","name":"Xeb","desc":"Replaces Privateer Costs 20% more production. May capture enemy ships upon their defeat (50% chance, captured units spawn with 50hp) . Is stronger (29 strength, vs. 27) and does not spend movement pillaging tiles."},{"type":"Bias","name":"Coastal","desc":""}]},"Turkey":{"leader":"Ataturk","entries":[{"type":"Ability","name":"Westernizatio","desc":"Amphitheaters, Opera Houses, Museums and Broadcast Towers are built +50% faster and each provide +1 Production, +1 Gold and +1 Science. +1 Production, +1 Gold and +1 Science from Great Works."},{"type":"Unit","name":"Kuva-yi Milliy","desc":"Replaces Great War Infantry. Weaker (47 Strength vs. 50) , but boasts 3 Movement (vs. 2) . Gains a +50% Combat Bonus when initiating combat, and may upgrade to Infantry for 0 Gold."},{"type":"Building","name":"Halkevleri","desc":"Replaces the Public School. In addition to typical perks, provides +3 Culture and is 20% cheaper to construct (160 hammers vs. 200)"},{"type":"Bias","name":"No","desc":"United Arab Emirates (UAE) Sheikh Zayed"},{"type":"Ability","name":"Yallah Habibi","desc":"Upon completing a World Wonder, receive 100 Gold and start a We Love The King Day in the City where it is built. All Units gain +3 Gold per turn and +1 Experience each turn on tiles with a Trade Route. (This King Day lasts for 15 turns and will stack with existing King Days.) (Gold and XP bonus is provided on each and every tile connecting the Trade Route.)"},{"type":"Building","name":"Burj","desc":"Replaces the Hotel. Available at Radio (instead of Refrigeration). Compared to the Hotel, the Burj provides +2 Gold and Culture to Great Person Improvements and Desert tiles in the City (with the exception of Floodplains)."},{"type":"Unit","name":"Qasimi Raider","desc":"Replaces the Privateer. Earns twice as much Gold from attacking Cities. Yields 2 movement points and 15 XP when plundering a trade-route. 8 Movement (vs. 6) , and 20% cheaper to construct (80 hammers vs. 100) . Promotions are kept on upgrade."},{"type":"Bias","name":"Coast","desc":""}]},"Ukraine":{"leader":"Yaroslav I","entries":[{"type":"Ability","name":"Chumatskyi Shli","desc":"+1 Food from Maize, Wheat and Salt resources after researching The Wheel. City Connections provide +2 Gold to connected Cities. (The Capital also receives +2 Gold after the first Connection is made.)"},{"type":"Unit","name":"Tachank","desc":"Replaces the Gatling Gun. Classified as a Mounted Ranged unit with 2 Range and 4 Movement and suffers the same Movement and Defensive Penalties as all Mounted Units. Upgrades to a normal Machine Gun."},{"type":"Building","name":"Knyaz Court","desc":"Replaces the Market. Compared to the Market, provides an additional point of Gold at base (2 vs. 1) . Each Knyaz Court in the empire generates 20 Gold whenever Ukraine consumes a Great Person."},{"type":"Bias","name":"Plains","desc":""}]},"Venice":{"leader":"Enrico Dandolo","entries":[{"type":"Ability","name":"Serenissim","desc":"Receive a free Trade Route and Cargo Ship in the Capital once Compass is researched. Cargo Ships may not be plundered. Capable of producing Settlers."},{"type":"Unit","name":"Great Galleass","desc":"(unchanged) - Replaces the Galleass. 18 Combat Strength (vs. 16) and 20 Ranged Strength (vs. 17) , but costs 10% more to produce (73 hammers vs. 67)"},{"type":"Unit","name":"The Merchant of Veni","desc":"Replaces Great Merchants. Extra embarked movement (6 vs. 4) and +100% bonus to influence and gold gained when conducting a trade-mission with a city-state. Has the \u2018buy city-state\u2019 ability, which gains you control over the city-state, including its territory and units (similar to Austria\u2019s Diplomatic Marriage). Must be in the territory of a city-state That city-state must not be allied to another player Not had a player other than you as an Ally in the past 5 turns and if it\u2019s currently your ally or unallied this may prevent the purchase for some turns"},{"type":"Bias","name":"Coast","desc":""}]},"Vietnam":{"leader":"Hai Ba Trung","entries":[{"type":"Ability","name":"Tam","desc":"Giai\u00e0o +2 Food, +1 Production from Marsh. +1 Faith from Jungle. Units receive double Movement through Marsh and Jungle tiles and receive a Combat Bonus in Marshes (+30%) and Jungles (+15%)."},{"type":"Unit","name":"Viet Co","desc":"Replaces Infantry. Moves further (3 Movement vs. 2) . When initiating combat, performs a bonus Ranged Attack prior to Melee combat. Gains a +25% Combat Bonus against Gunpowder units. Cheaper to construct (233 hammers vs. 280) . Loses abilities on upgrade."},{"type":"Building","name":"Vo Khi","desc":"Replaces the Armory, available at Metal Casting (instead of Steel). In addition to the typical perks, provides +1 Food, +1 Culture and +1 Production from Marsh tiles and +1 Culture from Jungle tiles. Doesn\u2019t require Barracks to construct."},{"type":"Bias","name":"Jungle, Wetlands (Marsh and Floodplains), Avoid desert","desc":""}]},"Wales":{"leader":"Owain Glyndwr","entries":[{"type":"Ability","name":"Hafod a Hendref","desc":"+1 Food and +1 Gold from Sheep at Animal Husbandry. Units receive a +10% Combat Bonus fighting in Hills."},{"type":"Unit","name":"Saethwyr","desc":"Replaces Crossbowmen. 15 Combat Strength (vs. 13)."},{"type":"Improvement","name":"Caer","desc":"Available at Chivalry. +3 Gold, +1 Culture, and +1 Production. Units gain a +25% Combat Bonus defending this tile. +1 Culture at Acoustics. Receives bonus yields from certain policies: +1 Culture from Cultural Exchange, +1 Science from Free Thought, +1 Food from completing the Commerce tree. May only be built on Hills without resources."},{"type":"Bias","name":"Hill","desc":""}]},"Yugoslavia":{"leader":"Aleksandar I","entries":[{"type":"Ability","name":"Non-Aligned Doctrine -","desc":"Pick a free Ideology Tenet when adopting or switching Ideologies and receive bonuses corresponding to both rival Ideologies. If not Freedom, Specialists provide +1 Gold. If not Autocracy, receive +15% Production towards land Units. If not Order, receive +2 Production and Science in all Cities."},{"type":"Unit","name":"M-84","desc":"Replaces Tanks. Ignores Zone of Control movement penalties. Uh oh. Loses ability on upgrade."},{"type":"Building","name":"Spomenik","desc":"Replaces Museums. In addition to the typical perks, provides +20% Science in the City, but costs more to construct (230 hammers vs. 200)"},{"type":"Bias","name":"No","desc":""}]},"Zimbabwe":{"leader":"Nyatsimba Mutota","entries":[{"type":"Ability","name":"Great Zimbabw","desc":"+25% Production towards buildings and military Units in the Capital. (Guilds and National and World Wonders do not count as buildings)."},{"type":"Unit","name":"Shona Warrior","desc":"Replaces the Warrior. 9 Strength (vs. 8) and is capable of building Quarries and Farms."},{"type":"Building","name":"Stone Maso","desc":"Replaces Stoneworks. Does not provide Happiness, but provides +2 Culture at Masonry, and otherwise retains the typical perks. Doesn\u2019t require any nearby resources to construct."},{"type":"Bias","name":"Hill","desc":""}]},"Zulu":{"leader":"Shaka","entries":[{"type":"Ability","name":"Iklw","desc":"(unchanged) Melee Units pay 50% less Gold maintenance. All Units require 25% less experience to promote."},{"type":"Building","name":"Ik","desc":"(unchanged) Replaces Barracks. Grants the Buffalo Horns promotion to all pre-Gunpowder Melee Units trained in the City and allows these Units to earn the Buffalo Chest and Loins promotions. Horns: +1 Movement, +25% Flanking Bonus, and +10% defensive Strength against Ranged attacks Chest: +10% Bonus in Open Terrain, an additional +25% Flanking Bonus, and an additional +10% defensive Strength against Ranged attacks (requires Horns) Loins: +10% Combat Strength, an additional +25% Flanking Bonus, and an additional +10% defensive Strength against Ranged attacks (requires Chest)"},{"type":"Unit","name":"Impi","desc":"(unchanged) Replaces Pikemen. When initiating combat, performs a bonus Ranged Attack prior to Melee combat. Gains +25% Combat Strength against Gunpowder units. Loses abilities on upgrade."},{"type":"Bias","name":"Avoid Jungl","desc":""}]}};
